##########################################################################################################################
# File automatically-generated by tool: [projectgenerator] version: [4.8.0-B50] date: [Mon Jan 19 12:16:03 EST 2026] 
##########################################################################################################################
...
LIBDIR = 
LDFLAGS = $(MCU) $(LIBS) -specs=nano.specs -specs=nosys.specs -T$(LDSCRIPT) $(LIBDIR) -Wl,-Map=$(BUILD_DIR)/$(TARGET).map,--cref -Wl,--gc-sections -Wl,--no-warn-rwx-segments

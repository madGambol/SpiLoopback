...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, INDICATOR_LED_Pin|LD2_Pin, GPIO_PIN_SET);
  ...
  /*Configure GPIO pins : INDICATOR_LED_Pin LD2_Pin */
  GPIO_InitStruct.Pin = INDICATOR_LED_Pin|LD2_Pin;
